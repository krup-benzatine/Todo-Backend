...
var signup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, userExist, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, userModel_1.User.create({ name: name_1, email: email, password: password })];
            case 2:
                user = _b.sent();
                return [2 /*return*/, res.status(200).json({ message: "User Created Successfully", user: user })];
            case 3:
                error_1 = _b.sent();
